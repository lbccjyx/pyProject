...
class BaseHandler(HandlerInterface):
    ...
    _CMD_CALLBACK_DICT: Dict[
        ...
        # 点赞
        'LIKE_INFO_V3_CLICK': _make_msg_callback('_on_live_like', web_models.LikeInfoV3ClickMessage),
        # 更新点赞
        'LIKE_INFO_V3_UPDATE': _make_msg_callback('_on_live_like_update', web_models.LikeInfoV3ClickUpdateMessage),

        'ENTRY_EFFECT': _make_msg_callback('_on_entry_effect', web_models.EntryEffectMessage),
    ...
    def _on_live_like(self, client: ws_base.WebSocketClientBase, message: web_models.LikeInfoV3ClickMessage):
        """
        偶尔触发的点赞数 每次应该算20个 有 限制 后面不再触发
        """
    def _on_live_like_update(self, client: ws_base.WebSocketClientBase, message: web_models.LikeInfoV3ClickUpdateMessage):
        """
        全直播间点赞数
        """
    def _on_entry_effect(self, client: ws_base.WebSocketClientBase, message: web_models.EntryEffectMessage):
        """
        点赞
        """
